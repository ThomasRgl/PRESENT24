...
present24 : main keys encryption decryption sort attack2 attack
	...
	$(GCC) -o fastPresent.out $(FLAG) builds/main.out builds/keys.out builds/encryption.out builds/decryption.out builds/attack2.out builds/sort.out  $(LFLAGS)
